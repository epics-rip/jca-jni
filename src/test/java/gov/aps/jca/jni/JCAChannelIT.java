 ...
 * @version $id$
 */
public class JCAChannelIT extends JCAIT{
    ...
    private class ConnectionListenerImpl implements ConnectionListener {
         ...
         */
        private Vector<ConnectionEvent> notifications = new Vector<ConnectionEvent>();
         ...
         */
        public Vector<ConnectionEvent> getNotifications() {
